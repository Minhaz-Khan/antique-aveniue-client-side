        ...
        <div className='mt-6'>
            ...
            <section className="container px-4 mx-auto">
                <div className="flex items-center justify-center gap-x-3">
                    <h2 className="text-xl font-medium text-gray-800 dark:text-white ">All Seller List</h2>
                </div>
                                    ...
                                    <tbody className="bg-white divide-y divide-gray-200 dark:divide-gray-700 dark:bg-gray-900">
                                        {allSeller && allSeller.map(seller => <tr key={seller._id}>
                                            <td className="px-4 py-4 text-sm font-medium text-gray-700 whitespace-nowrap">
                                                <div className="inline-flex items-center gap-x-3">
                                                    ...
                                                    <div className="flex items-center gap-x-2">
                                                        <img className="object-cover w-10 h-10 rounded-full" src={seller.image} alt="" />
                                            ...
                                            <td>
                                                ...
                                                <h2 className="font-medium text-gray-800 dark:text-white ">{seller.name}</h2>
