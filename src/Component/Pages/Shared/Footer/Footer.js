...
const Footer = () => {
    return (
        <div>
            <footer aria-label="Site Footer" className="bg-Beige">
                    ...
                    <div className="mx-auto max-w-md">
                        ...
                        <form className="mt-6">
                            <div className="relative max-w-lg">
                                ...
                                <button
                                    className="absolute top-1/2 right-1 -translate-y-1/2 rounded-full bg-maroon hover:bg-maroonLight px-5 py-3 text-sm font-medium text-white transition bg-coralRed"
                                >
                                    Subscribe
                                </button>
                            </div>
