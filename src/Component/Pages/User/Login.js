...
const Login = () => {
    ...
    return (
        <div className='h-screen flex items-center bg-Beige'>
            <div class="flex w-full h-4/6 max-w-sm mx-auto overflow-hidden bg-white rounded-lg shadow-lg dark:bg-gray-800 lg:max-w-4xl">
                <div class="hidden bg-cover lg:block lg:w-1/2 loginBg"  ></div>

                <div class="w-full px-6 py-8 md:px-8 my-auto lg:w-1/2">
                    ...
                    <div class="flex items-center justify-between mt-4">
                        ...
                        <Link to={'/singup'} class="text-xs text-gray-500 uppercase dark:text-gray-400 hover:underline">or sign up</Link>
