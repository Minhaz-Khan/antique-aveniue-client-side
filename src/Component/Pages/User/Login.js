...
const Login = () => {
    ...
    return (
        <div className='h-screen flex items-center bg-Beige'>
            <div className="flex w-full h-4/6 max-w-sm mx-auto overflow-hidden bg-white rounded-lg shadow-lg dark:bg-gray-800 lg:max-w-4xl">
                <div className="hidden bg-cover lg:block lg:w-1/2 loginBg"  ></div>

                <div className="w-full px-6 py-8 md:px-8 my-auto lg:w-1/2">
                    ...
                    <form onSubmit={handleSubmit(handleLogin)}>
                        ...
                        <div className="mt-4">
                            ...
                            <input {...register('email', { required: 'Email must be required' })} id="LoggingEmailAddress" className="block w-full px-4 py-2 text-gray-700 bg-white border rounded-lg dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600 focus:border-blue-400 focus:ring-opacity-40 dark:focus:border-blue-300 focus:outline-none focus:ring focus:ring-blue-300" type="email" />
